...
const service = axios.create({
  // 'baseURL': 'http://canzg-wsl.rjlxqh.net:8081/', // 'http://161.189.152.255:8081/',  // 'http://canzg-wsl.rjlxqh.net/enterpise', // https://mock.boxuegu.com/mock/872/', // 'http://172.16.43.139:8081/', // 'http://39.98.133.55:8081/', // https://mock.boxuegu.com/mock/872/', // process.env.VUE_APP_BASE_API,
